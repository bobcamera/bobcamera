...
<body>
    ...
    <script type="module">
        ...
        function init() {
            ...
            console.log("modify fetch(`http://localhost/bob_gui/src/html/proxy.php?... based on the actual filepath This is around line 94 in the 3d-adsb.php file");
            fetch(`http://localhost/bob_gui/src/html/proxy.php?lat=${centerPointlat}&lon=${centerPointlon}&dist=${radiusFromCenter}`)
