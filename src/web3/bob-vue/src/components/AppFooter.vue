<template>
  <v-footer height="40" app>
    ...
    >
      &copy; 2023-{{ (new Date()).getFullYear() }} <span class="d-none d-sm-inline-block">BOB Camera</span>
      —
      <a
  ...
  const items = [
    {
      title: 'BOB facebook',
      icon: 'mdi-facebook',
      href: 'https://www.facebook.com/groups/7533264616717176',
    },
    {
      title: 'BOB YouTube',
      icon: 'mdi-youtube',
      href: 'https://www.youtube.com/@BobUniversalObjectTracker',
    },
    {
      title: 'BOB X',
      ...
      href: 'https://x.com/BobUniversalObj',
    },
    {
      title: 'BOB GitHub',
      icon: `mdi-github`,
      href: 'https://github.com/bobcamera/bobcamera',
    },
    {
      title: 'BOB Discord',
      ...
      href: 'https://discord.gg/6k8juQ9Y',
    },
    {
      title: 'BOB Email',
      icon: 'mdi-email',
      href: 'mailto:uapbob@gmail.com',
    },
    // {
