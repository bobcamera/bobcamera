...
{
    return mat_ptr_->channels();
    // using_cuda_ ? gpu_mat_ptr_->channels() : mat_ptr_->channels();
}
...
{
    return mat_ptr_->elemSize();
    // using_cuda_ ? gpu_mat_ptr_->elemSize() : mat_ptr_->elemSize();
}

size_t Image::elemSize1() const
{
    return mat_ptr_->elemSize1();
    // using_cuda_ ? gpu_mat_ptr_->elemSize1() : mat_ptr_->elemSize1();
}

bool Image::empty() const
{
    return mat_ptr_->empty();
    // using_cuda_ ? gpu_mat_ptr_->empty() : mat_ptr_->empty();
}
...
{
    return mat_ptr_->size();
    // using_cuda_ ? gpu_mat_ptr_->size() : mat_ptr_->size();
}

size_t Image::step1() const
{
    return mat_ptr_->step1();
    // using_cuda_ ? gpu_mat_ptr_->step1() : mat_ptr_->step1();
}

size_t Image::total() const
{
    return mat_ptr_->total();
    // using_cuda_ ? gpu_mat_ptr_->size().area() : mat_ptr_->total();
}

int Image::type() const
{
    return mat_ptr_->type();
    // using_cuda_ ? gpu_mat_ptr_->type() : mat_ptr_->type();
}
