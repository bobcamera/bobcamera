...
using namespace boblib::blobs;
using namespace boblib::camera;
using namespace boblib::utils;

PYBIND11_MODULE(pyboblib, m)
{
    NDArrayConverter::init_numpy();

    m.doc() = "python wrapper for boblib using pybind11";
