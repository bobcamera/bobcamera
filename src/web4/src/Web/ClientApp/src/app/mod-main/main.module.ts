...
import { NotificationPublisher, NotificationHandler, ErrorService } from './services';
...
export const PROVIDERS = [NotificationPublisher, NotificationHandler, ErrorService ];
export const GUARDS = []
export const PIPES = [];
