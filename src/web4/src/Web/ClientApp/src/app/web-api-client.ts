...
export interface IRecordingsClient {
    getRecordings(directory: string | null | undefined): Observable<RecordingDto[]>;
    deleteRecording(file: string): Observable<void>;
}

@Injectable({
    providedIn: 'root'
})
export class RecordingsClient implements IRecordingsClient {
    ...
    getRecordings(directory: string | null | undefined): Observable<RecordingDto[]> {
        let url_ = this.baseUrl + "/api/Recordings?";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetRecordings(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetRecordings(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<RecordingDto[]>;
                }
            } else
                return _observableThrow(response_) as any as Observable<RecordingDto[]>;
        }));
    }

    protected processGetRecordings(response: HttpResponseBase): Observable<RecordingDto[]> {
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                ...
                for (let item of resultData200)
                    result200!.push(RecordingDto.fromJS(item));
            }
            else {
                result200 = <any>null;
            }
    ...
    deleteRecording(file: string): Observable<void> {
        let url_ = this.baseUrl + "/api/Recordings/{file}";
        ...
        return this.http.request("delete", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processDeleteRecording(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processDeleteRecording(response_ as any);
                } catch (e) {
    ...
    protected processDeleteRecording(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
