...
const OTHER_UI_MODULES: any[] = [FontAwesomeModule, NgxResizeObserverModule, TranslateModule];//MtxLuxonDatetimeModule , MtxDatetimepickerModule, MtxLoaderModule, MtxSplitModule];
