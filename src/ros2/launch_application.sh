...
export BOB_ENABLE_RECORDING=${BOB_ENABLE_RECORDING:-"True"}
...
# simulation
export BOB_SIMULATION_WIDTH=${BOB_SIMULATION_WIDTH:- "3840"}
export BOB_SIMULATION_HEIGHT=${BOB_SIMULATION_HEIGHT:- "2160"}
