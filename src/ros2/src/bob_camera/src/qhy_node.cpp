...
#include <boblib/api/utils/auto_exposure.hpp>
#include <boblib/api/utils/sub_sampler.hpp>
#include <boblib/api/utils/brightness_estimator.hpp>
...
private:
        ...
        std::vector<ParameterNode::ActionParam> params = {
            ...
            ParameterNode::ActionParam(
                ...
                [this](const rclcpp::Parameter& param) {
                    ...
                    qhy_camera_.set_control(boblib::camera::QhyCamera::ControlParam::Exposure, exposure);
                }
            ),
            ParameterNode::ActionParam(
                ...
                [this](const rclcpp::Parameter& param) {
                    ...
                    qhy_camera_.set_control(boblib::camera::QhyCamera::ControlParam::Gain, gain);
                }
            ),
            ParameterNode::ActionParam(
                ...
                [this](const rclcpp::Parameter& param) {
                    ...
                    qhy_camera_.set_control(boblib::camera::QhyCamera::ControlParam::Offset, offset);
                }
            ),
            ParameterNode::ActionParam(
                ...
                [this](const rclcpp::Parameter& param) {
                    ...
                    qhy_camera_.set_control(boblib::camera::QhyCamera::ControlParam::TransferBits, bpp);
                }
            ),
            ParameterNode::ActionParam(
                ...
                [this](const rclcpp::Parameter& param) {
                    ...
                    qhy_camera_.set_control(boblib::camera::QhyCamera::ControlParam::Contrast, contrast);
                }
            ),
            ParameterNode::ActionParam(
                ...
                [this](const rclcpp::Parameter& param) {
                    ...
                    qhy_camera_.set_control(boblib::camera::QhyCamera::ControlParam::Brightness, brightness);
                }
            ),
            ParameterNode::ActionParam(
                ...
                [this](const rclcpp::Parameter& param) {
                    ...
                    qhy_camera_.set_control(boblib::camera::QhyCamera::ControlParam::Gamma, gamma);
                }
            ),
            ParameterNode::ActionParam(
                ...
                [this](const rclcpp::Parameter& param) {
                    ...
                    qhy_camera_.set_bin_mode(boblib::camera::QhyCamera::BinMode(bin));
                }
            ),
            ParameterNode::ActionParam(
    ...
    inline void apply_auto_exposure(const cv::Mat &image, boblib::camera::QhyCamera::CameraParams &camera_params)
    {
    ...
    inline bob_camera::msg::ImageInfo generate_image_info(std_msgs::msg::Header &header, const boblib::camera::QhyCamera::CameraParams &camera_params)
    {
    ...
    static inline std::string convert_bayer_pattern(boblib::camera::QhyCamera::BayerFormat _bayerFormat)
    {
        switch (_bayerFormat)
        {
        case boblib::camera::QhyCamera::BayerFormat::BayerGB:
            return sensor_msgs::image_encodings::BAYER_GBRG8;
        case boblib::camera::QhyCamera::BayerFormat::BayerGR:
            return sensor_msgs::image_encodings::BAYER_GRBG8;
        case boblib::camera::QhyCamera::BayerFormat::BayerBG:
            return sensor_msgs::image_encodings::BAYER_BGGR8;
        case boblib::camera::QhyCamera::BayerFormat::BayerRG:
