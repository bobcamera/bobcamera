...
private:
    ...
    void init()
    {
        ...
        detector_bounding_boxes_subscription_ = std::make_shared<message_filters::Subscriber<vision_msgs::msg::BoundingBox2DArray>>(thisshared_from_this(), "bob/detector/all_sky/bounding_boxes");
